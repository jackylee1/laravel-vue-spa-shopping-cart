 ...
 * Generated for Laravel 5.6.39 on 2019-02-21 21:05:10.
 *
...
namespace Nestable\Facades { 
    ...
    class NestableService {
        ...
        {
            return \Nestable\Services\NestableService::firstUlAttr($attr, $value);
        }
        ...
        {
            return \Nestable\Services\NestableService::ul($items, $parent_id, $first);
        }
